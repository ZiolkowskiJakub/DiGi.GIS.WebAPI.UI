...
namespace DiGi.GIS.WebAPI.UI
{
    public static partial class Create
    {
        ...
        public static async Task<BuildingModel?> BuildingModelAsync(this HttpClient? httpClient, long id, int? countyId = null, double storeyHeight = Constants.Default.StoreyHeight, double tolerance = DiGi.Core.Constants.Tolerance.Distance)
        {
