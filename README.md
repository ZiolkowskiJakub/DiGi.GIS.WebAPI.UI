...
**DiGi.GIS.WebAPI.UI** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.GIS.WebAPI.UI](DiGi.GIS.WebAPI.UI)** (Path: `DiGi.GIS.WebAPI.UI\DiGi.GIS.WebAPI.UI`)
